...
gid = likeness_vitals.GID
pid = likeness_vitals.PID
cnt = likeness_vitals.CNT
...
class TestVitalsDisAggLocs:
    ...
    def setup_method(self, pnt_df_cnt):
        self.disagg_df = likeness_vitals.disaggregate(pnt_df_cnt, cnt, id_col=pid)
...
class TestVitalsSynthLocs:
    ...
    def setup_method(self, pnt_df_cnt, plg_df):
        ...
        self.minsep = 0.2
        self.maxsep = 2
        self.synthlocs_df = likeness_vitals.synthetic_locations(
            self.disagg_df,
            plg_df,
            gid,
            minsep=self.minsep,
...
class TestVitalsGeneratePnts:
    ...
    def setup_method(self, plg_df):
        ...
        self.minsep = 0.2
        self.maxsep = 2
        self.genpnts = likeness_vitals.generate_points(
            self.npoints,
...
class TestVitalsPointGenErrors:
    def test_maxsep_lt_minsep_error(self):
        ...
        with pytest.raises(ValueError, match="``maxsep < minsep``"):
            likeness_vitals.generate_points(None, None, None, minsep, maxsep, 10)
    ...
    def test_minsep_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.generate_points(None, None, None, minsep, 10, 10)
    ...
    def test_maxsep_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.generate_points(None, None, None, 10, maxsep, 10)
    ...
    def test_maxiter_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.generate_points(None, None, None, 10, 10, maxiter)
...
class TestVitalsSynthLocErrors:
    def test_maxsep_lt_minsep_error(self):
        ...
        maxsep = 5
        with pytest.raises(ValueError, match="``maxsep < minsep``"):
            likeness_vitals.synthetic_locations(
    ...
    def test_minsep_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.synthetic_locations(None, None, None, minsep=minsep)
    ...
    def test_maxsep_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.synthetic_locations(None, None, None, maxsep=maxsep)
    ...
    def test_maxiter_error(self):
        ...
        with pytest.raises(
            ...
            likeness_vitals.synthetic_locations(None, None, None, maxiter=maxiter)
